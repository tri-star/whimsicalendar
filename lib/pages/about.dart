  ...
  Widget _buildBodyPart(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<PackageInfo> snapshot) {
        const titleWidget = Text('Whimsicalendar', style: TextStyle(fontSize: 20));
        ...
        return Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Icons made by '),
                InkWell(child: Text('Freepik', style: TextStyle(color: Colors.blue, decoration: TextDecoration.underline)), onTap: () async {
            ...
            Row(
              ...
              children: [
                Text(' from '),
                InkWell(child: Text('www.flaticon.com', style: TextStyle(color: Colors.blue, decoration: TextDecoration.underline)), onTap: () async {
